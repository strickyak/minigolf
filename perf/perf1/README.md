...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `01_putchar` | **102** | 122 | 75 | 66 | 0.84x | 1.36x | 1.55x |
| `02_count_loop` | **898** | 895 | 542 | 531 | 1.00x | 1.66x | 1.69x |
| `03_arithmetic` | **14,337** | 14,679 | 16,390 | 16,409 | 0.98x | 0.87x | 0.87x |
| `04_fibonacci` | **18,882** | 14,322 | 12,466 | 11,519 | 1.32x | 1.51x | 1.64x |
| `05_array_sum` | **14,145** | 12,165 | 11,997 | 11,836 | 1.16x | 1.18x | 1.20x |
| `06_string_ops` | **10,182** | 7,271 | 5,643 | 5,319 | 1.40x | 1.80x | 1.91x |
| `07_sieve` | **25,757** | 17,772 | 14,256 | 14,800 | 1.45x | 1.81x | 1.74x |
...
| Benchmark Test | MiniGolf | CMOC (-O2) | GCC 6809 (-O2) | GCC6809 Max | MG vs CMOC | MG vs GCC | MG vs GCCMax |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `01_putchar` | **48 B** | 204 B | 92 B | 87 B | 0.24x | 0.52x | 0.55x |
| `02_count_loop` | **108 B** | 251 B | 139 B | 133 B | 0.43x | 0.78x | 0.81x |
| `03_arithmetic` | **673 B** | 659 B | 586 B | 548 B | 1.02x | 1.15x | 1.23x |
| `04_fibonacci` | **538 B** | 459 B | 362 B | 333 B | 1.17x | 1.49x | 1.62x |
| `05_array_sum` | **771 B** | 571 B | 373 B | 348 B | 1.35x | 2.07x | 2.22x |
| `06_string_ops` | **890 B** | 710 B | 514 B | 466 B | 1.25x | 1.73x | 1.91x |
| `07_sieve` | **630 B** | 537 B | 354 B | 329 B | 1.17x | 1.78x | 1.91x |
