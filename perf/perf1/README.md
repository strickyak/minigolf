...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| `01_putchar` | **102** | 122 | 75 | 66 | 1.36x | 1.55x |
| `02_count_loop` | **898** | 895 | 542 | 531 | 1.66x | 1.69x |
| `03_arithmetic` | **14,337** | 14,679 | 16,390 | 16,409 | 0.87x | 0.87x |
| `04_fibonacci` | **18,882** | 14,322 | 12,466 | 11,519 | 1.51x | 1.64x |
| `05_array_sum` | **14,145** | 12,165 | 11,997 | 11,836 | 1.18x | 1.20x |
| `06_string_ops` | **10,182** | 7,271 | 5,643 | 5,319 | 1.80x | 1.91x |
| `07_sieve` | **25,791** | 17,772 | 14,256 | 14,800 | 1.81x | 1.74x |
| `08_bubble_sort` | **53,435** | 44,102 | 42,391 | 41,207 | 1.26x | 1.30x |
| `09_struct_ops` | **9,953** | 8,173 | 8,015 | 7,891 | 1.24x | 1.26x |
| `10_switch_case` | **9,279** | 6,808 | 6,865 | 6,794 | 1.35x | 1.37x |

### Code Size (DECB Loaded Payload Bytes)

| Benchmark Test | MiniGolf | CMOC (-O2) | GCC 6809 (-O2) | GCC6809 Max | MG vs GCC | MG vs GCCMax |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| `01_putchar` | **48 B** | 204 B | 92 B | 87 B | 0.52x | 0.55x |
| `02_count_loop` | **108 B** | 251 B | 139 B | 133 B | 0.78x | 0.81x |
| `03_arithmetic` | **673 B** | 659 B | 586 B | 548 B | 1.15x | 1.23x |
| `04_fibonacci` | **538 B** | 459 B | 362 B | 333 B | 1.49x | 1.62x |
| `05_array_sum` | **771 B** | 571 B | 373 B | 348 B | 2.07x | 2.22x |
| `06_string_ops` | **890 B** | 710 B | 514 B | 466 B | 1.73x | 1.91x |
| `07_sieve` | **644 B** | 537 B | 354 B | 329 B | 1.82x | 1.96x |
| `08_bubble_sort` | **934 B** | 648 B | 427 B | 395 B | 2.19x | 2.36x |
| `09_struct_ops` | **1159 B** | 653 B | 326 B | 303 B | 3.56x | 3.83x |
| `10_switch_case` | **870 B** | 737 B | 593 B | 569 B | 1.47x | 1.53x |
