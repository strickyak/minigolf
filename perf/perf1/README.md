...
| `02_count_loop` | **766** | 895 | 542 | 531 | 1.41x | 1.44x |
| `03_arithmetic` | **14,348** | 14,679 | 16,390 | 16,409 | 0.88x | 0.87x |
| `04_fibonacci` | **20,309** | 14,322 | 12,466 | 11,519 | 1.63x | 1.76x |
| `05_array_sum` | **15,395** | 12,165 | 11,997 | 11,836 | 1.28x | 1.30x |
| `06_string_ops` | **24,984** | 7,271 | 5,643 | 5,319 | 4.43x | 4.70x |
| `07_sieve` | **26,792** | 17,772 | 14,256 | 14,800 | 1.88x | 1.81x |
| `08_bubble_sort` | **72,137** | 44,102 | 42,391 | 41,207 | 1.70x | 1.75x |
| `09_struct_ops` | **10,006** | 8,173 | 8,015 | 7,891 | 1.25x | 1.27x |
| `10_switch_case` | **11,041** | 6,808 | 6,865 | 6,794 | 1.61x | 1.63x |
...
| `02_count_loop` | **104 B** | 251 B | 139 B | 133 B | 0.75x | 0.78x |
| `03_arithmetic` | **702 B** | 659 B | 586 B | 548 B | 1.20x | 1.28x |
| `04_fibonacci` | **579 B** | 459 B | 362 B | 333 B | 1.60x | 1.74x |
| `05_array_sum` | **872 B** | 571 B | 373 B | 348 B | 2.34x | 2.51x |
| `06_string_ops` | **1401 B** | 710 B | 514 B | 466 B | 2.73x | 3.01x |
| `07_sieve` | **679 B** | 537 B | 354 B | 329 B | 1.92x | 2.06x |
| `08_bubble_sort` | **1034 B** | 648 B | 427 B | 395 B | 2.42x | 2.62x |
| `09_struct_ops` | **1218 B** | 653 B | 326 B | 303 B | 3.74x | 4.02x |
| `10_switch_case` | **907 B** | 737 B | 593 B | 569 B | 1.53x | 1.59x |
